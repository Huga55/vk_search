...
# Create VK Mini App2 [![npm][npm]][npm-url] [![deps][deps]][deps-url]

## How to install

### Create VK Mini App2 with gh-pages deploy

`npx @vkontakte/create-vk-mini-app <app-directory-name>`

### Create VK Mini App2 with Zeit deploy
...
### Create VK Mini App2 with Surge deploy
